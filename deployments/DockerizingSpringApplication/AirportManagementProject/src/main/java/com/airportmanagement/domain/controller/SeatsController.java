...
public class SeatsController {
  ...
  public ResponseEntity<List<Seat>> findSeatsByFareConditions(@PathVariable("fareCondition") @Valid @FareCondition String fareCondition) {
    List<Seat> seats = service.findSeatsByFareCondition(FareConditions.fromValue(fareCondition));
